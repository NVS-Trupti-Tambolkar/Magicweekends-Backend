...
const { insertTrip, getTrips, insertTripDirect, updateTrip, getTripById, deleteTrip, getFile, downloadBrochure } = require('../controllers/tripController');
...
router.get('/download-brochure/:id', downloadBrochure);
