...
const connectionString = process.env.DATABASE_URL || "postgresql://neondb_owner:npg_BCwoXK03sjYF@ep-patient-boat-a428xgfh-pooler.us-east-1.aws.neon.tech/neondb?sslmode=require";
...
const pool = new Pool({
  ...
  connectionTimeoutMillis: 0, // 0 prevents timeout during Neon's cold wakeups
